...
import { Di82Dto, Di82Service } from "app/@core/api";

@Component({
  selector: "ngx-read-di82",
  templateUrl: "./read-di82.component.html",
  styleUrls: ["./read-di82.component.scss"],
})
export class Di82ReadComponent implements OnInit {
  public settings = {
    hideSubHeader: true,
    edit: {
  ...
  constructor(private di82Service: Di82Service, public route: ActivatedRoute) {}

  ngOnInit() {
    this.route.data.subscribe((res) => {
      this.data = this.source = res.di82s.data;
      this.setZones();
    });
  }
