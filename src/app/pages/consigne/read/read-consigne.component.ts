...
import { ToggleFieldComponent } from "../../../../app/@theme/components";
...
export class ConsigneReadComponent implements OnInit {
  ...
  ngOnInit() {
    this.route.data.subscribe((res) => {
      this.data = this.source = res.consignes.data;
      this.setZones();
    });
  }
  ...
  public solder(consigne: ConsigneDto) {
    ...
    this.consigneService.updateConsigne(`${consigne.id}`, newConsigne).subscribe((res) => {
